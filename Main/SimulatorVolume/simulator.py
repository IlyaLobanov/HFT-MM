...
from SimulatorVolume.utils import Order, CancelOrder, OwnTrade, MdUpdate, update_best_positions, PriorQueue
...
class Sim:
    ...
    def update_md(self, md: MdUpdate) -> None:
        ...
        self.best_bid, self.best_ask, self.ask_quantity, self.bid_quantity \
            = update_best_positions(self.best_bid, self.best_ask, self.ask_quantity, self.bid_quantity, md)
